...
float upDownKey(GLFWwindow *window);
...
int main()
{
    ...
    GLFWwindow *window = glfwCreateWindow(wWidth, wheight, "name", NULL, NULL);
    if (window == NULL)
    {
  ...
  float vertices[] = {
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        chose += upDownKey(window);
        shaderProgram.setFloat("chose", chose);
        shaderProgram.use();
